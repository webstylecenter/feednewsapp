 ...
 */
final class Version20250916125328 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create entities from old FeedNews project into this project';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE feeds (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, color VARCHAR(191) NOT NULL, url LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_5A29F52F12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, name VARCHAR(255) NOT NULL, hide_xframe_notice TINYINT(1) DEFAULT 0 NOT NULL, enabled TINYINT(1) DEFAULT 1 NOT NULL, is_admin TINYINT(1) DEFAULT 0 NOT NULL, avatar VARCHAR(255) DEFAULT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, last_login DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE weather_forecasts (id INT AUTO_INCREMENT NOT NULL, location VARCHAR(255) NOT NULL, current_temp DOUBLE PRECISION NOT NULL, current_weather VARCHAR(255) NOT NULL, temp_today_max DOUBLE PRECISION NOT NULL, temp_today_min DOUBLE PRECISION NOT NULL, temp_in1_days_max DOUBLE PRECISION NOT NULL, temp_in1_days_min DOUBLE PRECISION NOT NULL, temp_in2_days_max DOUBLE PRECISION NOT NULL, temp_in2_days_min DOUBLE PRECISION NOT NULL, temp_in3_days_max DOUBLE PRECISION NOT NULL, temp_in3_days_min DOUBLE PRECISION NOT NULL, temp_in4_days_max DOUBLE PRECISION NOT NULL, temp_in4_days_min DOUBLE PRECISION NOT NULL, temp_in5_days_max DOUBLE PRECISION NOT NULL, temp_in5_days_min DOUBLE PRECISION NOT NULL, weather_in1_days VARCHAR(255) NOT NULL, weather_in2_days VARCHAR(255) NOT NULL, weather_in3_days VARCHAR(255) NOT NULL, weather_in4_days VARCHAR(255) NOT NULL, weather_in5_days VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE feeds ADD CONSTRAINT FK_5A29F52F12469DE2 FOREIGN KEY (category_id) REFERENCES feed_categories (id) ON DELETE SET NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE feeds DROP FOREIGN KEY FK_5A29F52F12469DE2');
